...
document.getElementById('nuevoCargo2').addEventListener('click', function (){
    document.getElementById("txtMensajeNuevo").innerText = "Nuevo";
    ...
    document.getElementById("btnRegistrarCargo").innerHTML = "Registrar Cargo <i class='fa-solid fa-floppy-disk'></i>";
...
const tblCargos = new Tabulator("#tblCargos", {
    ...
    columns: [
        ...
        { title: "Área", field: "area", hozAlign: "center", width: '25%' },
        { title: "Acciones", field: "acciones", hozAlign: "center", width: '15%', headerSort: false,
            ...
            cellClick: function(e, cell){
                if(e.target.classList.contains('btn-editar-cargo')){
                    ...
                    .then(response => {
                        ...
                        document.getElementById("txtMensajeNuevo").innerText = "Editar";
                        ...
                        document.getElementById("btnRegistrarCargo").innerHTML = "Guardad cambios <i class='fa-solid fa-pen'></i>";
