    ...
    <div class="grid lg:grid-cols-2 gap-6 mt-8">
        <div class="card overflow-hidden">
            ...
            <div class="w-full px-5 py-2 mt-3 flex justify-between items-center">
                <input type="text" id="buscarPersonal" placeholder="Buscar..."
            ...
            <form id="formDatos" class="p-6 space-y-8">
                    ...
                    <div class="p-6 space-y-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 fila-formulario items-center">
                            <div class="lg:col-span-1.5">
                                <label for="nombres_apellidos" class="text-sm font-medium inline-block mb-2">
                                    Nombres y Apellidos
                                </label>
                                <input type="text" id="nombres_apellidos" class="form-input w-full"
                                    placeholder="Ingrese nombres y apellidos completos" required>

                                <a href="https://eldni.com/pe/buscar-datos-por-dni" target="_blank"
                                    class="mt-3 btn border-primary text-primary hover:bg-primary hover:text-white">
                                    Consultar DNI
                                </a>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <div class="flex items-center justify-center rounded-lg w-32 h-32 relative">
                                    ...
                                    <div class="text-center w-full h-full flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg"
                                        id="placeholderFoto">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 fila-formulario">
                            <div>
                                ...
                                <input type="text" id="dni" maxlength="8" required class="form-input w-full"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 fila-formulario">
                            <div>
                                <label for="fecha_nacimiento" class="text-sm font-medium inline-block mb-2">Fecha
                                    Nacimiento</label>
                                <input type="date" id="fecha_nacimiento" required class="form-input w-full">
                            </div>
                            <div>
                        ...
                        <!-- Correo / WhatsApp -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 fila-formulario">
                            <div>
                                <label for="celular"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 fila-formulario">
                            <div>
                                <label for="sistema-previsional" class="text-sm font-medium inline-block mb-2">Sistema
                                    Previsional</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 fila-formulario">
                            <!-- <div>
                                <label for="grado-instruccion" class="text-sm font-medium inline-block mb-2">Grado de
                                    Instrucción</label>
                            ...
                            <div>
                                <label for="grado_instruccion" class="text-sm font-medium inline-block mb-2">Grado de Instrucción</label>
                                <input type="text" id="grado_instruccion" class="form-input w-full"
                                    placeholder="Grado de instrucción">
                            </div>
                            <div>
                                <label for="institucion" class="text-sm font-medium inline-block mb-2">Institución</label>
                                <input type="text" id="institucion" class="form-input w-full"
                            ...
                            <div>
                                ...
                                <input type="number" id="ano-egreso" class="form-input w-full" min="1950" max="2030"
                                    placeholder="2020">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 fila-formulario">
                            <div>
                                <label for="embargos" class="text-sm font-medium inline-block mb-2">Embargos en
                                    instituciones financieras</label>
                            ...
                            <div>
                                <label for="sustancias" class="text-sm font-medium inline-block mb-2">Consumo de sustancias
                                    ilícitas</label>
                        ...
                        <div class="space-y-4 fila-formulario">
                            <div>
                                <label for="direccion-actual" class="text-sm font-medium inline-block mb-2">Dirección
                                    Actual</label>
                                <textarea id="direccion-actual" required rows="2" class="form-input w-full"
                                    placeholder="Ingrese su dirección actual completa"></textarea>
                            </div>
                            <div>
                                <label for="direccion-dni" class="text-sm font-medium inline-block mb-2">Dirección
                                    DNI</label>
                                <textarea id="direccion-dni" rows="2" class="form-input w-full"
                                    placeholder="Dirección registrada en el DNI"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 fila-formulario">
                            <div>
                                <label for="emergencia-llamar" class="text-sm font-medium inline-block mb-2">En caso de
                                    Emergencia llamar a</label>
                                <input type="text" id="emergencia-llamar" class="form-input w-full"
                                    placeholder="Nombre completo">
                            </div>
                            <div>
                                <label for="celular-emergencia" class="text-sm font-medium inline-block mb-2">Número de
                                    celular</label>
                                <input type="text" id="celular-emergencia" maxlength="9" class="form-input w-full"
                                    placeholder="999 999 999">
                            </div>
                            <div>
                                <label for="parentesco" class="text-sm font-medium inline-block mb-2">Parentesco</label>
                                <input type="text" id="parentesco" class="form-input w-full"
                ...
                <div class="border rounded-lg shadow  mb-2">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 fila-formulario">
                            <div>
                                <label for="curso_sucamec" class="text-sm font-medium inline-block mb-2">Curso
                                    SUCAMEC</label>
                                <select id="curso_sucamec" class="form-select w-full">
                                    <option value="">Seleccionar</option>
                            ...
                            <div id="institucion_container" class="hidden">
                                <label for="institucion_laboral"
                                    class="text-sm font-medium inline-block mb-2">Institución</label>
                                <input type="text" id="institucion_laboral" class="form-input w-full"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 fila-formulario">
                            ...
                            <div>
                                <label for="tipo-vehiculo" class="text-sm font-medium inline-block mb-2">Tipo
                                    Vehículo</label>
                                <input type="text" id="tipo-vehiculo" class="form-input w-full"
                                    placeholder="Tipo de vehículo">
                            </div>
                            <div>
                                <label for="vehiculo-propio" class="text-sm font-medium inline-block mb-2">Vehículo
                                    Propio</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 fila-formulario">
                            <div>
                                <label for="empresa-anterior" class="text-sm font-medium inline-block mb-2">Empresa
                                    Anterior</label>
                                <input type="text" id="empresa-anterior" class="form-input w-full"
                                    placeholder="Nombre de la empresa">
                            </div>
                            <div>
                                <label for="cargo-anterior" class="text-sm font-medium inline-block mb-2">Cargo</label>
                                <input type="text" id="cargo-anterior" class="form-input w-full"
                                    placeholder="Cargo desempeñado">
                            </div>
                            <div>
                                <label for="duracion" class="text-sm font-medium inline-block mb-2">Duración</label>
                                <input type="text" id="duracion" class="form-input w-full"
                        ...
                        <div class="fila-formulario">
                            <label for="profesion-alterna" class="text-sm font-medium inline-block mb-2">Profesión u
                                Ocupación Alterna</label>
                            <input type="text" id="profesion-alterna" class="form-input w-full"
                ...
                <div class="border rounded-lg shadow  mb-2">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div id="familyContainer" class="space-y-4">
                            ...
                            <div class="family-row grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border rounded-lg relative">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="apellidosNombres[]" class="form-input w-full"
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button"
                                        class="remove-family self-end px-3 py-1 bg-red-100 text-red-600 rounded hover:bg-red-200">
                                        Eliminar
                                    </button>
                                </div>
                            </div>
                        ...
                        <button id="addFamilyMember" type="button"
                            class="w-full px-4 py-2 border rounded bg-gray-100 hover:bg-gray-200">
                            Agregar Familiar
                        </button>
                    </div>
                </div>
