        ...
        <div class="w-full px-5 py-2">
            <div class="flex justify-center items-center py-5 mt-5 gap-5">
                ...
                <div x-data>
                  ...
                  <!-- Coloca esto en un contenedor fuera del justify-center -->
                <div class="relative w-full flex justify-end px-6" x-data="{ open: false }">
                    ...
                    <!-- Modal de notificaciones alineado a la derecha -->
                    <div
                    x-show="open"
